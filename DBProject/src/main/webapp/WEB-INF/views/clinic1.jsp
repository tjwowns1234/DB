  ...
  <div id="wrapper" class="animate">
    ...
    <div class="container-fluid">
        ...
        <iframe id="msearch" name="msearch" src="http://localhost:8080/msearch" style="display: none;"></iframe>
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">질병 검색/목록</h5>
            ...
            <form name="f2" method="POST" action="clinic2">
            <input type="submit" class="btn btn-default btn-sm" value="저장하고 처방 약품 정하기" style="position:relative; float:right; right:20;">
                    ...
                    <table class="table">
                        <tbody>
                          ...
                          <tr>
                            <td>${a.di_id }</td>
                            <td>${a.di_name }</td>
                            <td><input type="radio" value="${a.di_id }" name="di_id"></td>
                          </tr>
                          </c:forEach>
                        </tbody>
                    </table>
